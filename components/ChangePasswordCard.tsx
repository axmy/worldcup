    ...
    <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center", padding: 22, background: "var(--bg)" }}>
      <div style={{ width: "100%", maxWidth: 408, animation: "authIn .5s cubic-bezier(.2,.7,.3,1) both" }}>
        ...
        <p style={{ color: "var(--text-dim)", fontSize: 15, marginTop: 11, lineHeight: 1.5 }}>
          This account uses a temporary password. Choose your own to continue.
        </p>
        ...
        <form action={formAction} style={{ marginTop: 22, display: "flex", flexDirection: "column", gap: 13 }}>
          <label style={{ display: "block" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 7 }}>
              ...
              <button type="button" className="auth-show" onClick={() => setShow((s) => !s)} style={{ fontSize: 12, fontWeight: 700, color: "var(--text-faint)", fontFamily: "var(--font-display)", letterSpacing: ".06em" }}>
                {show ? "HIDE" : "SHOW"}
              </button>
            </div>
          ...
          <button
            ...
            disabled={pending}
            style={{ marginTop: 4, height: 54, borderRadius: 14, fontFamily: "var(--font-display)", fontSize: 18, fontWeight: 900, letterSpacing: ".04em", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}
          >
